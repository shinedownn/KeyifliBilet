...
{
    public class MakeTicketResponseBookingInfo
    {
        public string pnr { get; set; }
    }

    public class MakeTicketResponseLeg
    {
    ...
    public class MakeTicketResponsePassenger
    {
    ...
    public class MakeTicketResponseResult
    {
        ...
        public MakeTicketResponseBookingInfo bookingInfo { get; set; }
        [JsonProperty(PropertyName = "legs")]
        public IList<MakeTicketResponseLeg> legs { get; set; }
        [JsonProperty(PropertyName = "passengers")]
        public IList<MakeTicketResponsePassenger> passengers { get; set; }
    }

    public class MakeTicketResponse
    {
        [JsonProperty(PropertyName = "result")]
        public MakeTicketResponseResult result { get; set; }
    }
}