       ...
       public CreditCardModel CreditCard { get; set; }
        ...
        public ResultMessageModel Payment()
        {
            try
            {
                switch (Bank)
                {
                    case (byte)KeyifliBilet.Models.Util.Banks.Garanti:
                        return Garanti();
                    case (byte)KeyifliBilet.Models.Util.Banks.Akbank:
                        return Akbank();
                    case (byte)KeyifliBilet.Models.Util.Banks.Garanti3D:
                        return Garanti3D();
                    case (byte)KeyifliBilet.Models.Util.Banks.Vakifbank:
                        return Vakifbank();
                    case (byte)KeyifliBilet.Models.Util.Banks.YapiKredi:
                        return YapiKredi();
                    case (byte)KeyifliBilet.Models.Util.Banks.Isbank:
                        return Isbank();
                    case (byte)KeyifliBilet.Models.Util.Banks.Finansbank:
                        return Finansbank();
                    default:
        ...
        ResultMessageModel Isbank()
        {
            try
            {
                ...
                #region Pos Configuration
                mycc5pay.name = "Metin";
                mycc5pay.password = "Metin1341?";
                mycc5pay.clientid = "700655000200";
               
                mycc5pay.orderresult = 1; // 0 : gercek islem, 1 : test islem
                mycc5pay.host = "https://entegrasyon.asseco-see.com.tr/fim/est3Dgate";
                //spos.isbank.com.tr
                #endregion
                ...
                if (Instalment > 1)
                    mycc5pay.taksit = Instalment.ToString();
                var data= mycc5pay.processorder();
